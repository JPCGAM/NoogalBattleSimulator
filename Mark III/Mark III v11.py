...
elif army1Tacktic == "defend" or army1Tacktic == "ambush":
...
army2_lightTank = int(input("How many light tanks does army 1 have? "))
...
elif army2Tacktic == "defend" or army2Tacktic == "ambush":
...
if army1Tacktic == "attack":
    ...
    army1_armour = 1+round((army1_medTank*medTankBaseStats[3]+army1_lightTank*lightTankBaseStats[3])*army1_moralle*army1_training*army1_supply,2)
...
if army2Tacktic == "attack":
    ...
    army2_armour = 1+round((army2_medTank*medTankBaseStats[3]+army2_lightTank*lightTankBaseStats[3])*army2_moralle*army2_training*army2_supply,2)
