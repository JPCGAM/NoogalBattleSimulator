...
###############################
if army1Tacktic == "attack":
    army1_soft_attack = round((army1inf*army1_used_stats_tactic[0]*random.uniform(0.8,1.2)+artHowBaseStats[0]*army1_artHow+army1_medTank*medTankBaseStats[0])*terrain_chosen[0],3)
    army1_hp = round((army1_used_stats_tactic[1]*army1inf*random.uniform(0.8,1.2)),3)
    army1_hard_attack = round((army1_used_stats_tactic[2]*army1inf*random.uniform(0.8,1.2)+artHowBaseStats[2]*army1_artHow+army1_medTank*medTankBaseStats[2])*terrain_chosen[2],3)
    ...
    army1_hp = round((army1_used_stats_tactic[1]*army1inf*random.uniform(0.8,1.2))*terrain_chosen[1],3)
...
if army2Tacktic == "attack":
    army2_soft_attack = round((army2inf*army2_used_stats_tactic[0]*random.uniform(0.8,1.2)+artHowBaseStats[0]*army2_artHow+army2_medTank*medTankBaseStats[0])*terrain_chosen[0],3)
    army2_hp = round(army2_used_stats_tactic[1]*army2inf*random.uniform(0.8,1.2),3)
    army2_hard_attack = round((army2_used_stats_tactic[2]*army2inf*random.uniform(0.8,1.2)+artHowBaseStats[2]*army2_artHow+army2_medTank*medTankBaseStats[2])*terrain_chosen[2],3)
    ...
    army2_hp = round((army2_used_stats_tactic[1]*army2inf*random.uniform(0.8,1.2))*terrain_chosen[1],3)
