...
infAmbushStats = [1, 4, 0.2, 0]
infAmbushSiegeDefend = [0.2, 4, 0, 0]
    #others
artHowBaseStats = [25,0,0.5,0]
medTankBaseStats = [12,9,5,2]
lightTankBaseStats = [15,6,2,0.5]
...
army1_lightTank = int(input("How many light tanks does army 1 have? "))
...
elif army1Tacktic == "defend" or army1Tacktic == "ambush" or army1Tacktic == "siege defend":
    if army1Tacktic == "defend":
        army1_used_stats_tactic = infBaseDefenceStats
    elif army1Tacktic == "ambush":
        army1Tacktic = "defend"
        army1_used_stats_tactic = infAmbushStats
    elif army1Tacktic == "siege defend":
        army1Tacktic = "defend"
        army1_used_stats_tactic = infAmbushSiegeDefend 
print()
...
army2_lightTank = int(input("How many light tanks does army 2 have? "))
...
elif army2Tacktic == "defend" or army2Tacktic == "ambush" or army2Tacktic == "siege defend":
    if army2Tacktic == "defend":
        army2_used_stats_tactic = infBaseDefenceStats
    elif army2Tacktic == "ambush":
        army2Tacktic = "defend"
        army2_used_stats_tactic = infAmbushStats
    elif army1Tacktic == "siege defend":
        army1Tacktic = "defend"
        army1_used_stats_tactic = infAmbushSiegeDefend
###############################
army1totaltanks = army1_lightTank+army1_medTank
army2totaltanks = army2_lightTank+army2_medTank
army1tankHP =  army1_lightTank*lightTankBaseStats[1]+army1_medTank*medTankBaseStats[1]
army2tankHP =  army2_lightTank*lightTankBaseStats[1]+army2_medTank*medTankBaseStats[1]

###############################
if army1Tacktic == "attack":
    army1_soft_attack = round((army1inf*army1_used_stats_tactic[0]*random.uniform(0.8,1.2)+artHowBaseStats[0]*army1_artHow+army1_medTank*medTankBaseStats[0]+army1_lightTank*lightTankBaseStats[0])*terrain_chosen[0]*army1_moralle*army1_training*army1_supply,3)
    army1_hp = round((army1_used_stats_tactic[1]*army1inf+army1tankHP)*random.uniform(0.8,1.2)*army1_moralle*army1_training*army1_supply,3)
    army1_hard_attack = round((army1_used_stats_tactic[2]*army1inf*random.uniform(0.8,1.2)+artHowBaseStats[2]*army1_artHow+army1_medTank*medTankBaseStats[2]+army1_lightTank*lightTankBaseStats[2])*terrain_chosen[2]*army1_moralle*army1_training*army1_supply,3)
    army1_armour = round((army1_medTank*medTankBaseStats[3]+army1_lightTank*lightTankBaseStats[3])*random.uniform(0.8,1.2)*army1_moralle*army1_training*army1_supply,2)
elif army1Tacktic == "defend":
    army1_soft_attack = round((army1inf*army1_used_stats_tactic[0]*random.uniform(0.8,1.2)+artHowBaseStats[0]*army1_artHow+army1_medTank*medTankBaseStats[0]+army1_lightTank*lightTankBaseStats[0])*army1_moralle*army1_training*army1_supply,3)
    army1_hp = round((army1_used_stats_tactic[1]*army1inf+army1tankHP)*random.uniform(0.8,1.2)*terrain_chosen[1]*army1_moralle*army1_training*army1_supply,3)
    army1_hard_attack = round((army1_used_stats_tactic[2]*army1inf*random.uniform(0.8,1.2)+artHowBaseStats[2]*army1_artHow+army1_medTank*medTankBaseStats[2]+army1_lightTank*lightTankBaseStats[2])*army1_moralle*army1_training*army1_supply,3)
    army1_armour = round((army1_medTank*medTankBaseStats[3]+army1_lightTank*lightTankBaseStats[3])*random.uniform(0.8,1.2)*army1_moralle*army1_training*army1_supply,2)
if army1_armour <=0:
    army1_armour = 1

if army2Tacktic == "attack":
    army2_soft_attack = round((army2inf*army2_used_stats_tactic[0]*random.uniform(0.8,1.2)+artHowBaseStats[0]*army2_artHow+army2_medTank*medTankBaseStats[0]+army2_lightTank*lightTankBaseStats[0])*terrain_chosen[0]*army2_moralle*army2_training*army2_supply,3)
    army2_hp = round((army2_used_stats_tactic[1]*army2inf+army2tankHP)*random.uniform(0.8,1.2)*army2_moralle*army2_training*army2_supply,3)
    army2_hard_attack = round((army2_used_stats_tactic[2]*army2inf*random.uniform(0.8,1.2)+artHowBaseStats[2]*army2_artHow+army2_medTank*medTankBaseStats[2]+army2_lightTank*lightTankBaseStats[2])*terrain_chosen[2]*army2_moralle*army2_training*army2_supply,3)
    army2_armour = round((army2_medTank*medTankBaseStats[3]+army2_lightTank*lightTankBaseStats[3])*random.uniform(0.8,1.2)*army2_moralle*army2_training*army2_supply,2)
elif army2Tacktic == "defend":
    army2_soft_attack = round((army2inf*army2_used_stats_tactic[0]*random.uniform(0.8,1.2)+artHowBaseStats[0]*army2_artHow+army2_medTank*medTankBaseStats[0]+army2_lightTank*lightTankBaseStats[0])*army2_moralle*army2_training*army2_supply,3)
    army2_hp = round((army2_used_stats_tactic[1]*army2inf+army2tankHP)*random.uniform(0.8,1.2)*terrain_chosen[1]*army2_moralle*army2_training*army2_supply,3)
    army2_hard_attack = round((army2_used_stats_tactic[2]*army2inf*random.uniform(0.8,1.2)+artHowBaseStats[2]*army2_artHow+army2_medTank*medTankBaseStats[2]+army2_lightTank*lightTankBaseStats[2])*army2_moralle*army2_training*army2_supply,3)
    army2_armour = round((army2_medTank*medTankBaseStats[3]+army2_lightTank*lightTankBaseStats[3])*random.uniform(0.8,1.2)*army2_moralle*army2_training*army2_supply,2)
if army2_armour <=0:
    army2_armour = 1
print(army1_armour,army1_hard_attack,army2_armour,army2_hard_attack)
print(army1_soft_attack, army1_hp, army1_hard_attack)
print(army2_soft_attack, army2_hp, army2_hard_attack)

print()
#A1C
if army1_armour > army2_hard_attack or army1_armour ==1:
    army1_left_hp = army1_hp- (army2_soft_attack/army1_armour)
    print("Army 1's tanks survived.")
    army1_tanks_left = army1totaltanks
elif army1_armour < army2_hard_attack and army1_armour >1 :
    army1_tank_destroyed_div = army1_armour/army2_hard_attack
    army1_left_hp = army1_hp- (army2_soft_attack/(army1_armour*army1_tank_destroyed_div*0.2))
    army1_tank_destroyed = round(army1totaltanks*(1-army1_tank_destroyed_div)*random.random(),0)
    army1_tank_damaged = round((army1totaltanks*(1-army1_tank_destroyed_div)) - army1_tank_destroyed,0)
    print(f"{army1_tank_destroyed} of Army's 1 tanks were destroyed and {army1_tank_damaged} were damaged. The rest survived.")
    army1_tanks_left = army1totaltanks - army1_tank_destroyed-army1_tank_damaged

if army1_left_hp > army1_hp:
    army1_left_hp = army1_hp
if army1tankHP ==0:
    army1_tanks_left = 1
army1_left_inf = int(round(army1_left_hp/army1_used_stats_tactic[1]-army1tankHP/army1_tanks_left,0))
if army1_left_hp < 0:
    army1_left_hp = 0
if army1_left_inf < 0:
    army1_left_inf = 0
...
if army2_armour > army1_hard_attack or army2_armour ==1:
    army2_left_hp = army2_hp- (army1_soft_attack/army2_armour)
    print("Army 2's tanks survived.")
    army2_tanks_left = army2totaltanks
elif army2_armour < army1_hard_attack and army2_armour >1:
    army2_tank_destroyed_div = army2_armour/army1_hard_attack
    army2_left_hp = army2_hp- (army1_soft_attack/(army2_armour*army2_tank_destroyed_div*0.2))
    army2_tank_destroyed = round(army2totaltanks*(1-army2_tank_destroyed_div)*random.random(),0)
    army2_tank_damaged = round((army2totaltanks*(1-army2_tank_destroyed_div)) - army2_tank_destroyed,0)
    print(f"{army2_tank_destroyed} of Army's 2 tanks were destroyed and {army2_tank_damaged} were damaged. The rest survived.")
    army2_tanks_left = army2totaltanks - army2_tank_destroyed-army2_tank_damaged
...
if army2tankHP ==0:
    army2_tanks_left = 1
army2_left_inf = int(round(army2_left_hp/army2_used_stats_tactic[1]-army2tankHP/army2_tanks_left,0))
if army2_left_hp < 0:
    army2_left_hp = 0
if army2_left_inf < 0:
    army2_left_inf = 0
