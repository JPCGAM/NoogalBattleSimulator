...
print(f"Total of {army1_inf_death} army 1 infantry cassualties. {army1_inf_wounded} infantry from army 1 were wounded and {army1_inf_died} were killed.")
...
print(f"Total of {army2_inf_death} army 2 infantry cassualties. {army2_inf_wounded} infantry from army 2 were wounded and {army2_inf_died} were killed.")
