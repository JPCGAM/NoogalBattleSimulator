...
if army1_armour > army2_hard_attack:
    ...
    print("All of Army's 2 tanks were destroyed.")
    #make it in later versions that it the tanks can survive if outtanked?
elif army1_armour < army2_hard_attack:
    army1_left_hp = army1_hp- (army2_soft_attack)
    print("All of Army's 1 tanks were destroyed.")
